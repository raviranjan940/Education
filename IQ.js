var questions = [{
    question: "1. P is a point on the line segment joining the points (3, 5, -1) and (6, 3, -2). If y-coordinate of point P is 2, then its x-coordinate will be",
    choices: ["2", "173", "152", "-5"],
    correctAnswer: 3
}, {
    ...
    choices: ["ECell and ∆rG of cell reaction both are extensive properties.", "ECell and ∆rG of cell reaction both are, intensive properties.	", "ECell is an intensive property while ∆rG of cell reaction is an extensive property.", "uECell is an extensive property while ∆rG of cell reaction is an intensive property."],
    correctAnswer: 3
},{
	question: "6. Colloidion is 4% solution of which one of the following in alcohol-ether mixture.",
    choices: ["Nitroglycerin", " Cellulose acetate", "SGlycol dinitrate", "Nitrocellulose"],
    correctAnswer: 4
},{
